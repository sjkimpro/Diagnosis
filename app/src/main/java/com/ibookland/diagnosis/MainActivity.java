package com.ibookland.diagnosis;
...
import com.ibookland.diagnosis.R;
import com.ibookland.diagnosis.MainActivity;
import com.ibookland.diagnosis.HttpUrl;
import com.ibookland.diagnosis.MainActivity.WebClient;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if ((keyCode == KeyEvent.KEYCODE_BACK)) {
            ...
            //        intent.setData(Uri.parse("market://details?id=com.ileaderschool.diagnosis"));
    ...
    private void initLayout() {
        ...
        mWeb = (WebView) findViewById(com.ibookland.diagnosis.R.id.webInfo);
